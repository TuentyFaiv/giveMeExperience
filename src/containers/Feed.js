  ...
  return (
    <section className="feed">
      ...
      <div className="postInput box">
        <HeaderPost />
        <textarea className="postInput-content" name="" id="" onInput={handleAutoHeight} placeholder="¿Tienes algo que compartir?"></textarea>
        <button className="postInput-submit">Publicar</button>
      </div>
      <PostBox>
